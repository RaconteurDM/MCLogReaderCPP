...
int($\ast$ {\bfseries x\+Create} )(\mbox{\hyperlink{structsqlite3}{sqlite3}} $\ast$, void $\ast$p\+Aux, int argc, const char $\ast$const $\ast$argv, \mbox{\hyperlink{structsqlite3__vtab}{sqlite3\+\_\+vtab}} $\ast$$\ast$pp\+VTab, char $\ast$$\ast$)
\item 
...
int($\ast$ {\bfseries x\+Connect} )(\mbox{\hyperlink{structsqlite3}{sqlite3}} $\ast$, void $\ast$p\+Aux, int argc, const char $\ast$const $\ast$argv, \mbox{\hyperlink{structsqlite3__vtab}{sqlite3\+\_\+vtab}} $\ast$$\ast$pp\+VTab, char $\ast$$\ast$)
\item 
...
Definition at line 7838 of file sqlite3.\+c.
